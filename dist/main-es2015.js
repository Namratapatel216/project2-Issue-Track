...
let dbx = new dropbox__WEBPACK_IMPORTED_MODULE_10__["Dropbox"]({ accessToken: '8OFJNocMFEAAAAAAAAAAYkSomdXBWRw9hBU2vZss-XAEp6ALCj0YhRuHIIzbU4Bo', fetch: fetch, });
let ParticularIssueComponent = class ParticularIssueComponent {
    ...
    ngOnInit() {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_9__(document).ready(function () {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_9__("#description_text_div").hover(function () {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_9__("#description_text_div").click(function () {
