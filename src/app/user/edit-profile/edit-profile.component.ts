...
export class EditProfileComponent implements OnInit {
      ...
      $('#mobileNumber').on('keypress, keydown', function(event) {
        ...
        $("#Username").blur(function () {
          ...
          else
          {
            ...
            {
              let logged_in_userid = (<HTMLInputElement>document.getElementById('logged_in_user_id')).value;
  ...
  public updated_code_length;
  public edit_profile_data = () => {
